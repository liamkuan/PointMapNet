...
work_dir = "work_dirs/pointmapnetv1"
custom_imports = dict(
    imports=[
        "plugin",
    ],
...
custom_hooks = [dict(type='ChangeWeightHook', epoch=12)]
...
model = dict(
    ...
    head=dict(
        ...
        loss_point_pts=dict(type="PtsL1Loss", loss_weight=100.0),
    ),
)
...
test_pipeline = [
    ...
    dict(type="AddRawPoint"),
    # dict(type="PositionEmbeddings", pc_range=pc_range, feat_shapes=[(30, 50), (15, 25)]),
    dict(
        type="PackMapInputs",
