...
class RCMapNet(Base3DDetector):
    ...
    def __init__(self,
        ...
        super(RCMapNet, self).__init__(data_preprocessor=data_preprocessor)
    ...
    def loss(self, batch_inputs: dict, batch_data_samples: List[Det3DDataSample]):
        ...
        with autocast(device_type='cuda', dtype=torch.float16, enabled=False):
            ...
            losses = self.head.loss(outs, gt_labels_3d, gt_lines_3d, raw_points, raw_points_label, point_masks, batch_inputs["image_depths"])
        return losses
